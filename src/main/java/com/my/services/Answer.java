...
public class Answer {
    ...
    public static final String TRY_LOAD_SUBJECTS =
            "Мне не удалось загрузить предметы из этого семестра первый раз, попробую еще раз...";

    public static final String TRY_LOAD_SUBJECTS_FAILED =
            "К сожалению, у меня не получилось загрузить предметы из твоего ЛК в этот раз. Попробуй позже";
